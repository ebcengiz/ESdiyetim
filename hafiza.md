...
**Kullanıcının yapacakları:** AdMob hesabı + App ID + 2 ad unit → `.env`; blocking controls; ASC App Privacy beyanı (rehber §4.3); yeni build (`eas build:version:set` ≥10); gerçek cihazda ATT + test reklamı; veri sorumlusu kimliğini PRIVACY.md'ye ekleme.
