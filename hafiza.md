...
- [ ] **Sunucu tarafını canlıya uygula — yeni uygulama build'inden ÖNCE:** (1) SQL Editor'de `20260925110000_…` ve `20260925120000_…` migration'ları; (2) Edge Functions secrets: `GEMINI_API_KEY`, `GROQ_API_KEY`; (3) `ai-proxy` deploy (Verify JWT kapalı) + `delete-account` yeniden deploy. Bkz. `GROQ_KURULUM.md`. Yayındaki 1.4.1 bundan etkilenmez (geriye uyumlu).
